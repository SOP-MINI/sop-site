...
Oraz z wtyczką **Code Runner**.

![](/img/vsc4.png) 

Są to wszystkie rozszerzenia potrzebne do wygodnej pracy z kodem w języku C.   

Utwórzmy teraz prosty projekt testowy `test`, a w nim pliki: `main.c` oraz `Makefile`:  
...
W Visual Studio Code klikamy w lewym górnym rogu `File -> Open Folder` i wybieramy nasz utworzony folder `test`.
