---
title: "W1. Systemy operacyjne i komputerowe - wstęp"
...
### Treści podstawowe
  ...
  - System komputerowy i jego 4 składniki.
  - Podstawowe tryby przetwarzania: wsadowy, z podziałem czasu (TS), interakcyjny, czasu rzeczywistego (RT)
  - Zadania systemu operacyjnego
  - Zasoby systemu komputerowego
  - Podsystemy systemu operacyjnego.
  - Wspólbieżność dostępu do zasobów
  - Funkcje systemowe, API systemu operacyjnego, standardy API. Biblioteki standardowe języka C: ANSI, POSIX (libc), GNU (glibc).
  - Struktury systemów operacyjnych: prosta, z monolitycznym jądrem, z mikrojądrem, hybrydowa; wykorzystanie ładowalnych modułów jądra.
